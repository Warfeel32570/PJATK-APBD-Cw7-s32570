...
namespace APBD_Cw7_s32570.Migrations
{
    ...
    [Migration("20260511192637_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APBD_Cw7_s32570.Models.Component", b =>
                {
            ...
            modelBuilder.Entity("APBD_Cw7_s32570.Models.ComponentManufacturer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APBD_Cw7_s32570.Models.ComponentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APBD_Cw7_s32570.Models.PC", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APBD_Cw7_s32570.Models.PCComponent", b =>
                {
                    b.Property<int>("PCId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APBD_Cw7_s32570.Models.Component", b =>
                {
                    b.HasOne("APBD_Cw7_s32570.Models.ComponentManufacturer", "Manufacturer")
                        .WithMany("Components")
                        .HasForeignKey("ComponentManufacturersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("APBD_Cw7_s32570.Models.ComponentType", "Type")
                        .WithMany("Components")
            ...
            modelBuilder.Entity("APBD_Cw7_s32570.Models.PCComponent", b =>
                {
                    b.HasOne("APBD_Cw7_s32570.Models.Component", "Component")
                        .WithMany("PCComponents")
                        .HasForeignKey("ComponentCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("APBD_Cw7_s32570.Models.PC", "PC")
                        .WithMany("PCComponents")
                        .HasForeignKey("PCId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
